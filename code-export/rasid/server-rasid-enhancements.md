# rasid - server-rasid-enhancements
    ...
    this.addTutorial({
      ...
      steps: [
        ...
        },
        {
          ...
          action: 'click',
          position: 'right',
          narration: 'الآن نحتاج لتحديد درجة الخطورة. هل حالة الرصد حرجة؟ عالية؟ متوسطة؟ أم منخفضة؟',
          autoExecute: false,
          duration: 3000,
        },
        {
    ...
    this.addTutorial({
      ...
      steps: [
        ...
        },
        {
          ...
          action: 'click',
          position: 'right',
          narration: 'الآن الجزء المهم! نحدد الشروط: مثلاً "عند إضافة حالة رصد خطورتها حرجة" أو "عند تسريب أكثر من 10,000 سجل".',
          autoExecute: false,
          duration: 6000,
        },
        {
