# rasid-leaks - client-lib

> Auto-extracted source code documentation

---

## `client/src/lib/atlas/assets.ts`

```typescript
/**
 * Rasid Brand Assets — CDN URLs
 * All logos, characters, and institutional branding
 * Updated with official transparent logos from brand kit
 */

export const RASID_ASSETS = {
  // ===== RASID LOGOS =====
  /** Calligraphy "راصد" — white/cream with gold outline (ideal for dark backgrounds, sidebar icon) */
  logoIcon: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663296955420/DWzmVhnhbNWANCJn.png",
  /** Same calligraphy — used for smaller badge/nav contexts */
  logoBadge: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663296955420/DWzmVhnhbNWANCJn.png",
  /** Full vertical logo with "منصة راصد" + "مكتب إدارة البيانات الوطنية" — light/gold variant */
  logoHorizontal: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663296955420/IWmOaxyfLfsgmFtK.png",
  /** Plain cream/white calligraphy — minimal variant for dark backgrounds */
  logoMinimal: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663296955420/fcsffAmIqjiZlkLQ.png",
  /** Navy blue with gold outline — for light backgrounds */
  logoDarkVariant: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663296955420/AbSIPlwSVIwIqOcc.png",
  /** Full logo navy+gold with "منصة راصد" text — for light backgrounds */
  logoFullDark: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663296955420/nDfQzMLaGbcMtLhp.png",

  /** Full vertical logo — calligraphy + "منصة راصد" + "مكتب إدارة البيانات الوطنية" — light/cream on transparent (login screen) */
  logoLoginFull: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663296955420/eckQHvLQnnkRsoUy.png",

  // ===== CHARACTERS =====
  /** Waving character — welcoming, best for home page */
  characterWaving: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663296955420/uGgUXbzQEvhpOxqr.png",
  /** Character with shmagh — professional */
  characterShmagh: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663296955420/NJGFEKLUzWzjrDlo.png",
  /** Character on dark background — best for dark theme */
  characterDark: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663296955420/RZhswZZINvRvFrjP.png",
  /** Character with sunglasses — cool/casual */
  characterSunglasses: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663296955420/KSSSXccrNPLZHmgq.png",
  /** Character arms crossed with shmagh — confident */
  characterConfident: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663296955420/OjbGmEggvEgEbsuK.png",
  /** Character standing with shmagh — formal */
  characterFormal: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663296955420/tAGqlxbKIaNohJLP.png",

  // ===== INSTITUTIONAL =====
  /** مكتب إدارة البيانات الوطنية — NDMO */
  ndmoLogo: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663296955420/cUPwrmGePuoPIPZI.png",
  /** الهيئة السعودية للبيانات والذكاء الاصطناعي — SDAIA */
  sdaiaLogo: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663296955420/OZKZOSAJtyWlpngO.png",
} as const;
...
## `client/src/lib/atlas/design.ts`

```typescript
/**
 * RASID Design System — Shared constants, colors, and utilities
 * Purple/Navy Glassmorphism — Sovereign Premium
 */

export const NEW_BG = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663296955420/jgTqAqImtcdwXLvR.png";

export const SENSITIVITY_COLORS = {
  high: { bg: "rgba(255, 77, 106, 0.15)", border: "rgba(255, 77, 106, 0.35)", text: "#FF6B7A", fill: "#DC3545" },
  medium: { bg: "rgba(240, 208, 96, 0.15)", border: "rgba(240, 208, 96, 0.35)", text: "#F0D060", fill: "#D4AF37" },
  low: { bg: "rgba(78, 205, 196, 0.15)", border: "rgba(78, 205, 196, 0.35)", text: "#5ECEC9", fill: "#3DB1AC" },
};

export const SENSITIVITY_AR: Record<string, string> = { high: "عالية الحساسية", medium: "متوسطة", low: "منخفضة" };
...
/**
 * Maps incident-level severity to summary-level severity.
 * Incidents use: حرج, مرتفع, متوسط, منخفض
 * Summary uses: واسع النطاق, مرتفع, متوسط, محدود
 */
export const INCIDENT_TO_SUMMARY_SEVERITY: Record<string, string> = {
  "حرج": "واسع النطاق",
  "مرتفع": "مرتفع",
  "متوسط": "متوسط",
  "منخفض": "محدود",
...
export const SUMMARY_TO_INCIDENT_SEVERITY: Record<string, string> = {
  "واسع النطاق": "حرج",
  "مرتفع": "مرتفع",
  "متوسط": "متوسط",
  "محدود": "منخفض",
...
export const ACCENT_ICON_COLORS: Record<string, { icon: string; glow: string }> = {
  crimson: { icon: "#FF4D6A", glow: "rgba(255,77,106,0.15)" },
  teal: { icon: "#4ECDC4", glow: "rgba(78,205,196,0.15)" },
  purple: { icon: "#8B7FD4", glow: "rgba(139,127,212,0.15)" },
  gold: { icon: "#F0D060", glow: "rgba(240,208,96,0.15)" },
  blue: { icon: "#5B9BD5", glow: "rgba(91,155,213,0.15)" },
  green: { icon: "#5CB85C", glow: "rgba(92,184,92,0.15)" },
};
...
/** Always returns English-formatted numbers */
...
/** Full English number format */
export function fmtFull(n: number): string {
  return n.toLocaleString("en-US");
}

/** Cinematic stagger variants for framer-motion */
...
## `client/src/lib/atlas/themeColors.ts`

```typescript
/**
 * Theme-aware color system for RASID Atlas
 * Returns appropriate colors based on current theme (dark/light)
 * Used by components that have hardcoded dark theme inline styles
 */
...
const DARK = {
  ...
  pageBg: "#0E0B24",
  /** Sidebar gradient */
  sidebarGradient: "linear-gradient(180deg, rgba(18,14,50,0.98) 0%, rgba(12,10,38,0.99) 100%)",
  /** Top bar gradient */
  topBarGradient: "linear-gradient(180deg, rgba(14,11,36,0.95) 0%, rgba(14,11,36,0.8) 100%)",
  topBarBorder: "1px solid rgba(120,100,200,0.08)",
  /** Panel/overlay backgrounds */
  panelGradient: "linear-gradient(180deg, rgba(20,16,48,0.99) 0%, rgba(12,10,35,0.99) 100%)",
  /** Glass card backgrounds */
  glassGradient: "linear-gradient(145deg, rgba(45,35,85,0.55) 0%, rgba(25,20,55,0.7) 50%, rgba(18,14,45,0.8) 100%)",
  glassBorder: "rgba(120,100,200,0.15)",
  glassHoverBorder: "rgba(120,100,200,0.35)",
  /** Chart tooltip */
  tooltipBg: "rgba(25,20,55,0.95)",
  tooltipBorder: "1px solid rgba(139,127,212,0.2)",
  /** Hero overlay */
  heroOverlay: "linear-gradient(135deg, rgba(14,11,36,0.85) 0%, rgba(14,11,36,0.6) 50%, rgba(14,11,36,0.9) 100%)",
  heroCardBg: "linear-gradient(135deg, rgba(45,35,85,0.6) 0%, rgba(25,20,55,0.8) 50%, rgba(14,11,36,0.95) 100%)",
  /** Auth screen */
  authBg: "linear-gradient(160deg, #0a0820 0%, #0E0B24 30%, #12103a 60%, #0a0820 100%)",
  /** Text colors */
  textPrimary: "#ffffff",
  ...
  textDim: "#64748b",
  /** Nav active item */
  navActiveBg: "linear-gradient(135deg, rgba(139,127,212,0.15), rgba(100,89,167,0.08))",
  navActiveBorder: "1px solid rgba(139,127,212,0.2)",
  navHoverBg: "rgba(255,255,255,0.03)",
  /** Sidebar border */
  sidebarBorder: "1px solid rgba(120,100,200,0.12)",
  sidebarDivider: "rgba(255,255,255,0.05)",
  /** Scrollbar */
  scrollTrack: "rgba(18,14,45,0.5)",
  scrollThumb: "rgba(120,100,200,0.3)",
  scrollThumbHover: "rgba(120,100,200,0.5)",
  /** Section divider */
  sectionDivider: "linear-gradient(90deg, transparent, rgba(120,100,200,0.3), transparent)",
};

/** Light theme colors — Elegant cream/slate with purple accents */
const LIGHT = {
  pageBg: "#f8f7f4",
  sidebarGradient: "linear-gradient(180deg, #ffffff 0%, #f8f7f4 100%)",
  topBarGradient: "linear-gradient(180deg, rgba(255,255,255,0.97) 0%, rgba(248,247,244,0.92) 100%)",
  topBarBorder: "1px solid rgba(120,100,200,0.1)",
  panelGradient: "linear-gradient(180deg, rgba(255,255,255,0.99) 0%, rgba(248,247,244,0.99) 100%)",
  glassGradient: "linear-gradient(145deg, rgba(255,255,255,0.85) 0%, rgba(248,247,244,0.9) 50%, rgba(240,238,232,0.95) 100%)",
  glassBorder: "rgba(120,100,200,0.12)",
  glassHoverBorder: "rgba(120,100,200,0.3)",
  tooltipBg: "rgba(255,255,255,0.97)",
  tooltipBorder: "1px solid rgba(120,100,200,0.15)",
  heroOverlay: "linear-gradient(135deg, rgba(248,247,244,1) 0%, rgba(248,247,244,1) 50%, rgba(248,247,244,1) 100%)",
  heroCardBg: "linear-gradient(135deg, rgba(255,255,255,0.8) 0%, rgba(248,247,244,0.9) 50%, rgba(240,238,232,0.95) 100%)",
  authBg: "linear-gradient(160deg, #f8f7f4 0%, #ffffff 30%, #f0eeea 60%, #f8f7f4 100%)",
  textPrimary: "#1e1b4b",
  textSecondary: "#334155",
  textMuted: "#64748b",
  textDim: "#94a3b8",
  navActiveBg: "linear-gradient(135deg, rgba(139,127,212,0.12), rgba(100,89,167,0.06))",
  navActiveBorder: "1px solid rgba(139,127,212,0.2)",
  navHoverBg: "rgba(139,127,212,0.05)",
  sidebarBorder: "1px solid rgba(120,100,200,0.1)",
  sidebarDivider: "rgba(120,100,200,0.08)",
  scrollTrack: "rgba(248,247,244,0.8)",
  scrollThumb: "rgba(120,100,200,0.2)",
  scrollThumbHover: "rgba(120,100,200,0.35)",
  sectionDivider: "linear-gradient(90deg, transparent, rgba(120,100,200,0.2), transparent)",
};
...
```typescript
// @ts-nocheck
// Data loaded from Database via API (centralized data source)
// Fallback to CDN if API is unavailable
const API_URL = "/api/trpc/leaks.fullData";
const CDN_FALLBACK_URL = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663331132774/bUJvkvCfCGUNRpsw.json";
let rawData: any[] = [];
try {
  const resp = await fetch(API_URL);
  const json = await resp.json();
  rawData = json?.result?.data?.json || [];
  if (!rawData.length) throw new Error("Empty API response");
} catch(e) {
  // Fallback to CDN
  try {
    const resp = await fetch(CDN_FALLBACK_URL);
...
const COLORS = {
  primary: [100, 80, 180] as [number, number, number],
...
export const leakRecords: LeakRecord[] = [
  {
    ...
    descriptionAr: "حالة رصد ضخمة لقاعدة بيانات موظفي وزارة الخارجية السعودية نُشر على BreachForums بواسطة مهاجم 'IntelBroker'. يحتوي على 1.4 مليون سجل تشمل بيانات اعتماد دبلوماسية وأرقام هوية ومعلومات اتصال شخصية.",
  },
  {
    id: "LK-2024-0003",
...
export const telegramChannels: MonitoringChannel[] = [
  { id: "CH-TG-001", name: "Saudi Leaks حالة رصدات سعودية", platform: "Telegram", subscribers: 45000, status: "flagged", lastActivity: "2026-02-10T16:00:00", leaksDetected: 18, riskLevel: "high" },
...
export const piiPatterns: PIIMatch[] = [
  { type: "National ID", typeAr: "رقم الهوية الوطنية", pattern: "1\\d{9}", count: 4850000, sample: "1087456321", category: "Identity" },
  { type: "Iqama Number", typeAr: "رقم الإقامة", pattern: "2\\d{9}", count: 1920000, sample: "2394017856", category: "Identity" },
  { type: "Saudi Phone", typeAr: "رقم جوال سعودي", pattern: "05\\d{8}", count: 6340000, sample: "0534821976", category: "Contact" },
  { type: "Saudi Email", typeAr: "بريد إلكتروني سعودي", pattern: ".*@.*\\.sa", count: 1280000, sample: "user@domain.sa", category: "Contact" },
  { type: "IBAN", typeAr: "رقم الحساب البنكي", pattern: "SA\\d{22}", count: 895000, sample: "SA4420000001234567891234", category: "Financial" },
  ...
  { type: "Medical Record", typeAr: "سجل طبي", pattern: "MRN-\\d+", count: 2100000, sample: "MRN-4827163", category: "Health" },
];
...
## `client/src/lib/themeAccents.ts`

```typescript
/**
 * Theme Accent Colors — centralized color config for all 7 themes
 * Used by DashboardLayout, pages, and components to dynamically style
 * based on the active design style (theme).
 */
import type { DesignStyle } from "@/contexts/ThemeContext";
...
export interface ThemeAccent {
  ...
  /** Aurora gradient colors (dark mode background effects) */
  aurora1: string;
  aurora2: string;
  aurora3: string;
...
export const themeAccents: Record<DesignStyle, ThemeAccent> = {
  sdaia: {
    accent: "#3DB1AC",
    accentLight: "#6459A7",
    accentBg: "rgba(61,177,172,0.1)",
    accentBgLight: "rgba(120,100,200,0.06)",
    accentBorder: "rgba(61,177,172,0.25)",
    accentBorderLight: "rgba(120,100,200,0.12)",
    sidebarBg: "rgba(13,21,41,0.98)",
    sidebarBgLight: "rgba(255,255,255,0.98)",
    sidebarBorder: "rgba(61,177,172,0.08)",
    sidebarBorderLight: "#e2e5ef",
    headerBg: "rgba(13,21,41,0.85)",
    headerBgLight: "rgba(255,255,255,0.95)",
    textPrimary: "#D4DDEF",
    textPrimaryLight: "#1c2833",
    textSecondary: "rgba(212,221,239,0.6)",
    textSecondaryLight: "#5a6478",
    aurora1: "radial-gradient(ellipse at 70% 20%, rgba(61,177,172,0.3), transparent 70%)",
    aurora2: "radial-gradient(ellipse at 30% 80%, rgba(100,80,180,0.25), transparent 60%)",
    aurora3: "radial-gradient(ellipse at center, rgba(100,89,167,0.2), transparent 50%)",
    glow: "0 0 8px rgba(61,177,172,0.4)",
  },
  atlas: {
    accent: "#8B7FD4",
    accentLight: "#6459A7",
    accentBg: "rgba(139,127,212,0.1)",
    accentBgLight: "rgba(100,89,167,0.06)",
    accentBorder: "rgba(139,127,212,0.25)",
    accentBorderLight: "rgba(100,89,167,0.12)",
    sidebarBg: "rgba(18,14,50,0.98)",
    sidebarBgLight: "rgba(248,247,244,0.98)",
    sidebarBorder: "rgba(139,127,212,0.08)",
    sidebarBorderLight: "rgba(120,100,200,0.1)",
    headerBg: "rgba(14,11,36,0.85)",
    headerBgLight: "rgba(248,247,244,0.95)",
    textPrimary: "#E1DEF5",
    textPrimaryLight: "#2D2354",
    textSecondary: "rgba(225,222,245,0.6)",
    textSecondaryLight: "#6B5F9E",
    aurora1: "radial-gradient(ellipse at 70% 20%, rgba(139,127,212,0.3), transparent 70%)",
    aurora2: "radial-gradient(ellipse at 30% 80%, rgba(45,35,85,0.3), transparent 60%)",
    aurora3: "radial-gradient(ellipse at center, rgba(78,205,196,0.15), transparent 50%)",
    glow: "0 0 8px rgba(139,127,212,0.4)",
  },
  luxury: {
    accent: "#F7B558",
    accentLight: "#B8860B",
    accentBg: "rgba(247,181,88,0.1)",
    accentBgLight: "rgba(184,134,11,0.06)",
    accentBorder: "rgba(247,181,88,0.25)",
    accentBorderLight: "rgba(184,134,11,0.12)",
    sidebarBg: "rgba(15,24,48,0.98)",
    sidebarBgLight: "rgba(247,244,238,0.98)",
    sidebarBorder: "rgba(247,181,88,0.08)",
    sidebarBorderLight: "rgba(184,134,11,0.1)",
    headerBg: "rgba(15,24,48,0.85)",
    headerBgLight: "rgba(247,244,238,0.95)",
    textPrimary: "#F0E6D3",
    textPrimaryLight: "#2C1810",
    textSecondary: "rgba(240,230,211,0.6)",
    textSecondaryLight: "#8B7355",
    aurora1: "radial-gradient(ellipse at 70% 20%, rgba(247,181,88,0.2), transparent 70%)",
    aurora2: "radial-gradient(ellipse at 30% 80%, rgba(139,69,19,0.15), transparent 60%)",
    aurora3: "radial-gradient(ellipse at center, rgba(218,165,32,0.1), transparent 50%)",
    glow: "0 0 8px rgba(247,181,88,0.4)",
  },
  cyber: {
    accent: "#00FF88",
    accentLight: "#059669",
    accentBg: "rgba(0,255,136,0.08)",
    accentBgLight: "rgba(5,150,105,0.06)",
    accentBorder: "rgba(0,255,136,0.2)",
    accentBorderLight: "rgba(5,150,105,0.12)",
    sidebarBg: "rgba(10,14,26,0.98)",
    sidebarBgLight: "rgba(240,253,244,0.98)",
    sidebarBorder: "rgba(0,255,136,0.06)",
    sidebarBorderLight: "rgba(5,150,105,0.1)",
    headerBg: "rgba(10,14,26,0.85)",
    headerBgLight: "rgba(240,253,244,0.95)",
    textPrimary: "#C8F7DC",
    textPrimaryLight: "#064E3B",
    textSecondary: "rgba(200,247,220,0.6)",
    textSecondaryLight: "#4B7C5F",
    aurora1: "radial-gradient(ellipse at 70% 20%, rgba(0,255,136,0.15), transparent 70%)",
    aurora2: "radial-gradient(ellipse at 30% 80%, rgba(0,100,60,0.15), transparent 60%)",
    aurora3: "radial-gradient(ellipse at center, rgba(0,200,100,0.08), transparent 50%)",
  ...
  minimal: {
    ...
    accentBgLight: "rgba(24,24,27,0.04)",
    accentBorder: "rgba(113,113,122,0.2)",
    accentBorderLight: "rgba(24,24,27,0.08)",
    sidebarBg: "rgba(24,24,27,0.98)",
    sidebarBgLight: "rgba(250,250,250,0.98)",
    sidebarBorder: "rgba(113,113,122,0.08)",
    sidebarBorderLight: "#e4e4e7",
    headerBg: "rgba(24,24,27,0.85)",
    headerBgLight: "rgba(250,250,250,0.95)",
    textPrimary: "#E4E4E7",
    textPrimaryLight: "#18181B",
    textSecondary: "rgba(228,228,231,0.6)",
  ...
  silver: {
    accent: "#8A9BB0",
    accentLight: "#3A4A5C",
    accentBg: "rgba(138,155,176,0.1)",
    accentBgLight: "rgba(58,74,92,0.06)",
    accentBorder: "rgba(138,155,176,0.2)",
    accentBorderLight: "rgba(58,74,92,0.1)",
    sidebarBg: "rgba(28,38,53,0.98)",
    sidebarBgLight: "rgba(232,236,242,0.98)",
    sidebarBorder: "rgba(138,155,176,0.1)",
    sidebarBorderLight: "rgba(58,74,92,0.08)",
    headerBg: "rgba(28,38,53,0.9)",
    headerBgLight: "rgba(240,243,248,0.95)",
    textPrimary: "#D0D8E4",
    textPrimaryLight: "#2A3545",
    textSecondary: "rgba(208,216,228,0.6)",
    textSecondaryLight: "#5A6A7C",
    aurora1: "radial-gradient(ellipse at 70% 20%, rgba(138,155,176,0.15), transparent 70%)",
    aurora2: "radial-gradient(ellipse at 30% 80%, rgba(58,74,92,0.12), transparent 60%)",
    aurora3: "radial-gradient(ellipse at center, rgba(90,112,144,0.08), transparent 50%)",
    glow: "0 0 8px rgba(138,155,176,0.3)",
  },
  gold3d: {
    accent: "#F7B558",
    accentLight: "#B8860B",
    accentBg: "rgba(247,181,88,0.08)",
    accentBgLight: "rgba(184,134,11,0.06)",
    accentBorder: "rgba(201,185,162,0.2)",
    accentBorderLight: "rgba(184,134,11,0.1)",
    sidebarBg: "rgba(20,30,48,0.98)",
    sidebarBgLight: "rgba(245,240,232,0.98)",
    sidebarBorder: "rgba(201,185,162,0.08)",
    sidebarBorderLight: "rgba(184,134,11,0.08)",
    headerBg: "rgba(20,30,48,0.9)",
    headerBgLight: "rgba(255,251,245,0.95)",
    textPrimary: "#F0E6D3",
    textPrimaryLight: "#2C1810",
    textSecondary: "rgba(240,230,211,0.6)",
    textSecondaryLight: "#8B7355",
    aurora1: "radial-gradient(ellipse at 70% 20%, rgba(247,181,88,0.15), transparent 70%)",
    aurora2: "radial-gradient(ellipse at 30% 80%, rgba(139,105,20,0.1), transparent 60%)",
    aurora3: "radial-gradient(ellipse at center, rgba(201,160,64,0.08), transparent 50%)",
    glow: "0 0 8px rgba(247,181,88,0.4)",
  },
};

/** Get accent colors for the current design style */
export function getThemeAccent(style: DesignStyle): ThemeAccent {
  return themeAccents[style] || themeAccents.sdaia;
}
...
```typescript
/**
 * Theme-aware color system for RASID Platform
 * Returns appropriate colors based on current theme (dark/light)
 * Copied from rasid-atlas design system — MUST remain in sync
 */
...
```typescript
/**
 * Typography System — Rasid Platform
 * نظام الخطوط الموحد لمنصة راصد
 * 
 * Font: Tajawal (Arabic) + DM Sans (English)
 * Scale: Major Third (1.25)
 */

export const fontFamily = {
  ar: "'Tajawal', 'Cairo', 'Noto Kufi Arabic', sans-serif",
  en: "'DM Sans', 'Inter', sans-serif",
...
export const fontSize = {
  ...
  h2: "1.5rem",
  /** 1.25rem / 20px — Sub-section headers */
  h3: "1.25rem",
  /** 1rem / 16px — Card titles, subtitles */
  subtitle: "1rem",
  /** 0.875rem / 14px — Body text */
  body: "0.875rem",
  /** 0.75rem / 12px — Captions, labels */
  caption: "0.75rem",
  /** 0.625rem / 10px — Micro text, badges */
  micro: "0.625rem",
} as const;
...
export const textStyle = {
  h1: { fontFamily: fontFamily.ar, fontSize: fontSize.h1, fontWeight: fontWeight.bold, lineHeight: lineHeight.tight },
  h2: { fontFamily: fontFamily.ar, fontSize: fontSize.h2, fontWeight: fontWeight.bold, lineHeight: lineHeight.snug },
  h3: { fontFamily: fontFamily.ar, fontSize: fontSize.h3, fontWeight: fontWeight.semibold, lineHeight: lineHeight.normal },
  subtitle: { fontFamily: fontFamily.ar, fontSize: fontSize.subtitle, fontWeight: fontWeight.semibold, lineHeight: lineHeight.normal },
  body: { fontFamily: fontFamily.ar, fontSize: fontSize.body, fontWeight: fontWeight.regular, lineHeight: lineHeight.relaxed },
  caption: { fontFamily: fontFamily.ar, fontSize: fontSize.caption, fontWeight: fontWeight.regular, lineHeight: lineHeight.normal },
  micro: { fontFamily: fontFamily.ar, fontSize: fontSize.micro, fontWeight: fontWeight.medium, lineHeight: lineHeight.normal },
  /** English body text */
  bodyEn: { fontFamily: fontFamily.en, fontSize: fontSize.body, fontWeight: fontWeight.regular, lineHeight: lineHeight.relaxed },
  /** Monospace for code/hashes */
  mono: { fontFamily: fontFamily.mono, fontSize: fontSize.caption, fontWeight: fontWeight.regular, lineHeight: lineHeight.normal },
} as const;

/** Responsive font sizes for mobile (< 640px) */
