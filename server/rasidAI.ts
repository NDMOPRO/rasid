...
function getPDPLArticleInfo(articleNumber?: number, topic?: string): any {
  const articles: Record<number, { title: string; summary: string; requirements: string[] }> = {
    ...
    20: { title: "الإبلاغ عن حالات الرصد", summary: "يجب إبلاغ الجهة المختصة خلال 72 ساعة من اكتشاف أي حالة رصد", requirements: ["إبلاغ خلال 72 ساعة", "وصف حالة الرصد", "تقييم الأثر", "إجراءات التخفيف", "إبلاغ المتضررين"] },
