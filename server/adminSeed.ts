...
const PAGE_PERMISSIONS = [
  ...
  { resourceId: "page:incident-compare", name: "مقارنة الحوادث", nameEn: "Incident Compare" },
  { resourceId: "page:campaign-tracker", name: "تتبع الحملات", nameEn: "Campaign Tracker" },
  { resourceId: "page:incidents-registry", name: "سجل الحوادث", nameEn: "Incidents Registry" },
...
const FEATURE_PERMISSIONS = [
  ...
  { resourceId: "feature:incident-certification", name: "توثيق الحوادث", nameEn: "Incident Certification" },
