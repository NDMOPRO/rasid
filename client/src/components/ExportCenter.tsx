...
function generateCSV(leaks: any[]): string {
  const headers = ["العنوان", "القطاع", "المصدر", "مستوى التأثير", "ادعاء البائع", "تاريخ الاكتشاف", "الحالة"];
...
export default function ExportCenter({ isOpen, onClose, stats, leaks }: ExportCenterProps) {
  ...
  const handleExport = async () => {
    ...
    if (selectedFormat === "csv") {
      ...
      const headers = ["العنوان", "القطاع", "المصدر", "مستوى التأثير", "ادعاء البائع", "تاريخ الاكتشاف"];
