    ...
    <div className="space-y-6" dir="rtl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {[
          ...
          { color: "blue", icon: <AlertTriangle className="h-5 w-5 text-blue-400" />, value: stats.byType.incident_report, label: "توثيق حالات الرصد" },
          ...
          {selectedDoc && (
            <>
              ...
              <div className="space-y-4 mt-4">
                ...
                {/* Leak Reference */}
                <div className="bg-muted/20 rounded-lg p-3 border border-border/30">
                  <p className="text-[10px] text-muted-foreground mb-1">حالة الرصد المرتبطة</p>
                  <button
