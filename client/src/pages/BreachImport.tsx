/**
 * BreachImport — صفحة استيراد بيانات حالات التسريب
...
export default function BreachImport() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      formData.append("platform", workspace);
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className={`text-2xl font-bold ${isDark ? "text-white" : "text-gray-900"}`}>
            استيراد بيانات حالات التسريب
          </h1>
          <p className={`text-sm mt-1 ${isDark ? "text-slate-400" : "text-gray-500"}`}>
            تغذية المنصة ببيانات حالات تسريب البيانات الشخصية
          </p>
        </div>
      </div>
            ...
            <CardContent>
              ...
              >
                ...
                <p className={`text-xs mt-2 ${isDark ? "text-gray-500" : "text-gray-400"}`}>
                  يدعم: JSON, CSV, XLSX, ZIP (حتى 500 ميجابايت)
                </p>
              </div>
