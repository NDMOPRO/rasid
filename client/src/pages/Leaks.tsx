                              ...
                              <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4 flex items-start gap-3">
                                ...
                                <div>
                                  ...
                                  <p className="text-xs text-muted-foreground mt-1">
                                    هذه عينة من البيانات الشخصية التي تم اكتشافها في حالة الرصد. تم عرض {samples.length} سجلات من أصل {leakDetail.recordCount.toLocaleString()} سجل (ادعاء البائع).
                            ...
                            return (
                              <div className="bg-secondary/30 rounded-xl p-4 border border-border/30">
                                <h4 className="text-xs font-semibold text-muted-foreground mb-3 flex items-center gap-1.5">
                                  ...
                                  لقطات شاشة من مصدر البيع ({screenshots.length})
                                </h4>
                          ...
                          <div className="text-center py-12">
                            {enrichingId === leakDetail.leakId ? (
                              ...
                              <div>
                                ...
                                <p className="text-muted-foreground text-sm mb-4">لم يتم إثراء حالة الرصد هذه بالذكاء الاصطناعي بعد</p>
                                <Button
