...
const mockReports: ReportItem[] = [
  { id: "RPT-2026-001", title: "تقرير حالات رصد القطاع المالي - يناير 2026", type: "شهري", createdAt: "2026-01-28", author: "msarhan", status: "pending", priority: "critical", summary: "تقرير شامل يغطي 23 حالة رصد في القطاع المالي خلال شهر يناير، بما في ذلك 3 حالات رصد عالية الأهمية تتعلق ببيانات بطاقات ائتمانية.", leakCount: 23, affectedEntities: 8 },
  { id: "RPT-2026-002", title: "تقرير الرصد الأسبوعي - الأسبوع 4", type: "أسبوعي", createdAt: "2026-01-25", author: "malmoutaz", status: "pending", priority: "high", summary: "رصد 15 حالة رصد جديدة على الدارك ويب تتضمن بيانات شخصية لمواطنين سعوديين، منها 5 حالات رصد تتعلق ببيانات صحية.", leakCount: 15, affectedEntities: 5 },
  ...
  { id: "RPT-2026-005", title: "تقرير حالة رصد طوارئ - حالة رصد بيانات صحية", type: "طوارئ", createdAt: "2026-01-08", author: "aalrebdi", status: "rejected", priority: "critical", summary: "تقرير طوارئ حول حالة رصد بيانات 50,000 سجل صحي. تم رفض التقرير لعدم اكتمال تحليل الأثر وطلب إعادة المراجعة.", leakCount: 1, affectedEntities: 3 },
